...
exports.ZONA_POR_MUNICIPIO = exports.MUNICIPIOS = exports.DEPARTAMENTOS = exports.CAT_022_TIPO_DOCUMENTO_RECEPTOR = exports.CAT_019_CONDICION_OPERACION = exports.CAT_017_FORMA_PAGO = exports.CAT_014_UNIDAD_MEDIDA = exports.CAT_005_TIPO_ITEM = exports.CAT_002_TIPO_DTE = exports.CAT_001_AMBIENTE = void 0;
...
function getMunicipios(departamentoCod) {
    const munis = exports.MUNICIPIOS[departamentoCod];
    if (!munis)
        return [];
...
function getZona(departamentoCod, municipioCod) {
    return exports.ZONA_POR_MUNICIPIO[`${departamentoCod}/${municipioCod}`];
}
