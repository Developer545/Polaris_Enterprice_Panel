...
import {
  ...
  App, Tooltip, Divider, theme, Empty, Popover,
} from 'antd'
import {
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(10, 1fr)', gap: 2 }}>
            <div
              ...
              style={{
                ...
                borderRadius: 4, background: !value ? '#f0f0f0' : 'transparent', lineHeight: 1.6,
              }}
            >
              ✕
            </div>
...
export default function ServicesPage() {
  ...
  const columns: ColumnsType<any> = [
    ...
    {
      title: 'Precio', dataIndex: 'price', key: 'price', width: 105, align: 'right',
      render: (v: any) => (
        <Text strong style={{ color: token.colorPrimary, fontSize: 13 }}>${Number(v).toFixed(2)}</Text>
      ),
    },
    {
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <Form.Item name="emoji" label="Emoji / Ícono visual" style={{ marginBottom: 14 }}>
            <EmojiPicker />
          </Form.Item>
