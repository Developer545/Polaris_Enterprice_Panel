  ...
  return (
    <LoginSplitBase companyId={companyId}>
      <div style={{
        ...
        background: '#060b18',
        backgroundImage: [
          'radial-gradient(ellipse 80% 60% at 20% 30%, rgba(59,130,246,0.28) 0%, transparent 60%)',
          'radial-gradient(ellipse 60% 50% at 80% 75%, rgba(96,165,250,0.18) 0%, transparent 55%)',
          'radial-gradient(rgba(96,165,250,0.15) 1px, transparent 1px)',
        ].join(', '),
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 52 }}>
            <div style={{
              ...
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M12 2L20.66 7V17L12 22L3.34 17V7L12 2Z" stroke={AC} strokeWidth="1.5" fill="rgba(59,130,246,0.2)" />
                <path d="M12 6L17 8.5V13.5L12 16L7 13.5V8.5L12 6Z" fill="rgba(96,165,250,0.3)" stroke="rgba(147,197,253,0.8)" strokeWidth="0.75" />
              </svg>
            </div>
            <div>
          ...
          <div style={{ height: 1, background: 'rgba(59,130,246,0.25)', marginBottom: 36 }} />
