  ...
  return (
    <LoginSplitBase companyId={companyId}>
      <div style={{
        ...
        background: '#0d1117',
        backgroundImage: 'radial-gradient(ellipse 75% 50% at 20% 25%, rgba(59,130,246,0.20) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 75%, rgba(96,165,250,0.12) 0%, transparent 55%), repeating-linear-gradient(135deg, transparent, transparent 23px, rgba(96,165,250,0.04) 23px, rgba(96,165,250,0.04) 24px)',
