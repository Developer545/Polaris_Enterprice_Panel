  ...
  return (
    <LoginSplitBase companyId={companyId}>
      <div style={{
        ...
        background: '#0d0800',
        backgroundImage: 'radial-gradient(ellipse 75% 55% at 15% 35%, rgba(245,158,11,0.22) 0%, transparent 60%), radial-gradient(ellipse 55% 40% at 85% 70%, rgba(251,191,36,0.12) 0%, transparent 55%)',
