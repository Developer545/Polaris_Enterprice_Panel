  ...
  return (
    <LoginSplitBase companyId={companyId}>
      <div style={{
        ...
        background: '#030e12',
        backgroundImage: 'radial-gradient(ellipse 70% 50% at 30% 30%, rgba(6,182,212,0.22) 0%, transparent 60%), radial-gradient(ellipse 55% 40% at 75% 70%, rgba(34,211,238,0.14) 0%, transparent 55%), radial-gradient(rgba(6,182,212,0.12) 1px, transparent 1px)',
