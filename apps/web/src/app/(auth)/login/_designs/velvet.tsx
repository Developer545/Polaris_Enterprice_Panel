  ...
  return (
    <LoginSplitBase companyId={companyId}>
      <div style={{
        ...
        background: '#0d0409',
        backgroundImage: 'radial-gradient(ellipse 70% 50% at 25% 30%, rgba(190,18,60,0.22) 0%, transparent 60%), radial-gradient(ellipse 55% 40% at 75% 70%, rgba(251,113,133,0.14) 0%, transparent 55%)',
